...
5. Write `docs/2-tech/1-architecture/ctx-001-system-context.md` with identifier `[CTX-001]`
...
4. Write `docs/2-tech/1-architecture/adr/adr-{id}-{slug}.md` per ADR with identifier `[ADR-xxx]`
...
3. Write `docs/2-tech/1-architecture/stk-001-stack-conventions.md` with identifier `[STK-001]`
...
2. Write `docs/2-tech/1-architecture/enb-000-index.md`

## Output

- `docs/2-tech/1-architecture/ctx-001-system-context.md` — `[CTX-001]`
- `docs/2-tech/1-architecture/adr/adr-{id}-{slug}.md` — `[ADR-xxx]` (N ADRs)
- `docs/2-tech/1-architecture/stk-001-stack-conventions.md` — `[STK-001]`
- `docs/2-tech/1-architecture/enb-000-index.md` — enabler index
