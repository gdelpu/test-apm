...
5. Write `docs/2-tech/2-design/dat-001-data-model.md` with identifier `[DAT-001]`
...
5. Write `docs/2-tech/2-design/api-{id}-{slug}.md` per API group with identifier `[API-xxx]`
...
5. Write `docs/2-tech/2-design/tst-001-test-strategy.md` with identifier `[TST-001]`
...
5. Write `docs/2-tech/2-design/imp-001-implementation-plan.md` with identifier `[IMP-001]`
6. Write project root `CLAUDE.md`

## Output

- `docs/2-tech/2-design/dat-001-data-model.md` — `[DAT-001]`
- `docs/2-tech/2-design/api-{id}-{slug}.md` — `[API-xxx]` (per API group)
- `docs/2-tech/2-design/tst-001-test-strategy.md` — `[TST-001]`
- `docs/2-tech/2-design/imp-001-implementation-plan.md` — `[IMP-001]`
