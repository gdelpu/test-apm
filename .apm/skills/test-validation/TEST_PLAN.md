...
```bash
git add .apm/skills/test-validation/scenarios/scenario-1-all-validators-fire/
...
1. **skill_frontmatter_missing** (.apm/skills/test-validation/scenarios/scenario-1-all-validators-fire/SKILL.md)
...
```bash
git add .apm/skills/test-validation/scenarios/scenario-2-partial-fix/
...
```bash
git add .apm/skills/test-validation/scenarios/scenario-3-warnings-only/
...
```bash
git add .apm/skills/test-validation/scenarios/scenario-4-human-gate/
...
git add .apm/skills/test-validation/scenarios/scenario-4-human-gate/SKILL.md
...
```bash
git add .apm/skills/test-validation/scenarios/scenario-5-yaml-parse-error/
...
```bash
git add .apm/skills/test-validation/scenarios/scenario-6-clean-pass/
