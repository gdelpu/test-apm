...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.apm/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run specify init to scaffold .apm/templates, or add agent-file-template.md there.'
        exit 1
    }
}
