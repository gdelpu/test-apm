...
- Agent manifest: `station-workflows/schemas/agent-manifest.schema.json`
- Skill manifest: `station-workflows/schemas/skill-manifest.schema.json`
...
See `station-workflows/stations/a3-prompt-injection.prompt.md` for the full regex table.
