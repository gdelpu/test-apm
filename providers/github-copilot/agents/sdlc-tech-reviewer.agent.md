...
- Never write files to paths outside `outputs/docs/2-tech/reviews/` or `outputs/reviews/`. Reject any file path argument containing `..` or absolute path components.
