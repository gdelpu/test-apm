...
| Knowledge | `.apm/knowledge/` | ✅ All bundles |

The **.apm/knowledge/** folder is distributed as part of the canonical layer — it contains the
...
|----------------|----------|
| `.apm/knowledge/constitution/` | Engineering principles, enterprise defaults, greenfield/brownfield guides |
| `.apm/knowledge/governance/` | Architecture principles, security/testing policies, JSON schemas |
| `.apm/knowledge/playbooks/` | Brownfield, greenfield, modernization, workflow playbooks |
| `.apm/knowledge/brand/` | Sopra Steria brand guidelines, icons, logos, templates |
