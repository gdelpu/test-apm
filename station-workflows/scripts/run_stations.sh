...
# station-workflows/stations/, sorts them by prefix (a0, a1, …), and
...
STATION_DIR="${PROJECT_DIR}/station-workflows/stations"
STATION_OUT="${STATION_OUT:-station_out}"
EXTRACT_JSON="${PROJECT_DIR}/station-workflows/scripts/extract_json.py"
