...
| Path | Purpose |
|------|---------|
| `.apm/agents/` | Cross-provider agent definitions (22 agents) |
| `.apm/skills/` | Skill packages: `SKILL.md` + optional `tools/`, `docs/` (88 skills) |
...
| `providers/claude-code/` | Claude Code adapter (`CLAUDE.md`, 38 commands) |
...
- **Provider layer** (source of truth for Copilot-format files):
  - Agents: `providers/github-copilot/agents/*.agent.md` (6 agents)
  - Prompts: `providers/github-copilot/prompts/*.prompt.md` (4 standalone + 13 workflow + 26 SDLC)
...
- Commands: `providers/claude-code/commands/*.md` (7 workflow + 31 SDLC)
